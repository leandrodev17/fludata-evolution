...
import { InstanceDto, SetPresenceDto, SetTranscriptionDto } from '@api/dto/instance.dto';
import { instanceController } from '@api/server.module';
import { ConfigService } from '@config/env.config';
import { instanceSchema, presenceOnlySchema, transcriptionSchema } from '@validate/validate.schema';
...
export class InstanceRouter extends RouterBroker {
  constructor(
    ...
    this.router
      ...
      .post(this.routerPath('setTranscription'), ...guards, async (req, res) => {
        const response = await this.dataValidate<null>({
          request: req,
          schema: transcriptionSchema,
          ClassRef: SetTranscriptionDto,
          execute: (instance, data) => instanceController.setTranscription(instance, data),
        });
